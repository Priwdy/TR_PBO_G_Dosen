...
import Controller.ControllerTambahMahasiswa;
...
public class TambahMahasiswa extends javax.swing.JFrame {
    ...
    private final ControllerTambahMahasiswa controller = new ControllerTambahMahasiswa();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String namaMhs = jTextField1.getText(); 
        ...
        Mahasiswa_UKSW mhsBaru = new Mahasiswa_UKSW(nim, namaMhs);

        try {
            boolean success = controller.tambahMahasiswa(mhsBaru);
            
            if (success) {
                JOptionPane.showMessageDialog(this, 
                    "Mahasiswa " + mhsBaru.getNamaMahasiswa() + " (NIM: " + mhsBaru.getNIM() + ") berhasil ditambahkan!\n" +
             ...
             if (e.getErrorCode() == 1062) { 
                 JOptionPane.showMessageDialog(this, "Gagal: NIM " + nim + " sudah terdaftar.", "Error", JOptionPane.ERROR_MESSAGE);
             } else {
                 JOptionPane.showMessageDialog(this, "Gagal menambah mahasiswa:\n" + e.getMessage(), "Error Database", JOptionPane.ERROR_MESSAGE);
             }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(this, 
            "Yakin hapus data mahasiswa NIM: " + nimToDelete + "?\n(Akun login juga akan dihapus!)", 
            "Konfirmasi Hapus", 
            JOptionPane.YES_NO_OPTION);

        if (confirm == JOptionPane.YES_OPTION) {
            try {
                boolean success = controller.hapusMahasiswa(nimToDelete);
                if (success) {
    ...
    private void load_table_data() { 
        DefaultTableModel model = controller.getDaftarMahasiswa();
